...
internal class Parser(CommentStripper lexer)
{
    private readonly CommentStripper lexer = lexer;
    ...
    public Token ExpectReservedWord(string reservedWord, string message = null)
    {
    ...
    public Token ExpectSymbol(string symbol, string message = null)
    {
        var token = this.lexer.Next();
    ...
    public Dictionary<string, Node> ParseDeclarations(SymbolTable symbolTable)
    {
    ...
    public List<Node> ParseDeclaration(SymbolTable symbolTable)
    {
        var token = this.lexer.Peek();
    ...
    public List<Node> ParseUsesDeclaration(SymbolTable symbolTable)
    {
                                                 ...
                                                 int nodeType, Func<SymbolTable, Node> rhsFn, Node forceType = null)
    {
        ...
        {
            this.ExpectSymbol(token.value);
        }
        else
        {
            this.ExpectReservedWord(token.value);
        }
